    ...
    public static class NewInstrumentation extends Instrumentation {
        ...
        public void callActivityOnCreate(Activity activity, Bundle icicle) {
            if (isCollect){
                ...
                activityInfo.activityName = activity==null?"":activity.getClass().getName();
                activityInfo.hashCode = activity==null?"":(""+activity.hashCode());
                activityInfo.methodName = "onCreate(Bundle)";
        ...
        public void callActivityOnCreate(Activity activity, Bundle icicle, PersistableBundle persistentState) {
            if (isCollect){
                ...
                activityInfo.activityName = activity==null?"":activity.getClass().getName();
                activityInfo.hashCode = activity==null?"":(""+activity.hashCode());
                activityInfo.methodName = "onCreate(Bundle,PersistableBundle)";
                activityInfo.startTime = start;
                activityInfo.endTime = end;
                ActivityCollector.sendInfo(activityInfo,false);
            }else {
        ...
        public void callActivityOnStart(Activity activity) {
            if (isCollect){
                ...
                activityInfo.activityName = activity==null?"":activity.getClass().getName();
                activityInfo.hashCode = activity==null?"":(""+activity.hashCode());
                activityInfo.methodName = "onStart()";
                activityInfo.startTime = start;
                activityInfo.endTime = end;
                ActivityCollector.sendInfo(activityInfo,false);
            }else {
        ...
        public void callActivityOnResume(Activity activity) {
            if (isCollect){
                ...
                activityInfo.activityName = activity==null?"":activity.getClass().getName();
                activityInfo.hashCode = activity==null?"":(""+activity.hashCode());
                activityInfo.methodName = "onResume()";
                activityInfo.startTime = start;
                activityInfo.endTime = end;
                ActivityCollector.sendInfo(activityInfo,false);
            }else {
        ...
        public void callActivityOnPause(Activity activity) {
            if (isCollect){
                ...
                activityInfo.activityName = activity==null?"":activity.getClass().getName();
                activityInfo.hashCode = activity==null?"":(""+activity.hashCode());
                activityInfo.methodName = "onPause()";
                activityInfo.startTime = start;
                activityInfo.endTime = end;
                ActivityCollector.sendInfo(activityInfo,false);
            }else {
        ...
        public void callActivityOnStop(Activity activity) {
            if (isCollect){
                ...
                activityInfo.activityName = activity==null?"":activity.getClass().getName();
                activityInfo.hashCode = activity==null?"":(""+activity.hashCode());
                activityInfo.methodName = "onStop()";
                activityInfo.startTime = start;
                activityInfo.endTime = end;
                ActivityCollector.sendInfo(activityInfo,false);
            }else {
        ...
        public void callActivityOnDestroy(Activity activity) {
            if (isCollect){
                ...
                activityInfo.activityName = activity==null?"":activity.getClass().getName();
                activityInfo.hashCode = activity==null?"":(""+activity.hashCode());
                activityInfo.methodName = "onDestroy()";
                activityInfo.startTime = start;
                activityInfo.endTime = end;
                ActivityCollector.sendInfo(activityInfo,false);
            }else {
